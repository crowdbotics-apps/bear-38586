"""
Django settings for bear_38586 project.
...
WSGI_APPLICATION = 'bear_38586.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "bear_38586 API",
    "DESCRIPTION": "API documentation for bear_38586 App",
    "VERSION": "v1",
}
